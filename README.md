...
- 94 documented traits. Hovering the **i** on any of them shows both what
  the trait does at the table *and* what it does to the challenge rating.
...
means one *rung*, so a CR ⅛ monster with a strong AC steps to ¼ rather than
...
The layout follows /u/ItsADnDMonsterNow's original CR calculator. This is an
independent rewrite, not a copy of their code.
